package org.foi.nwtis.bsikac.aplikacija_4.slusaci;
...
public class SlusacAplikacije implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
    	...
    	context.setAttribute("sustav.korisnik", konfig.dajPostavku("sustav.korisnik"));
    	context.setAttribute("sustav.lozinka", konfig.dajPostavku("sustav.lozinka"));
